  if helpAlert == 1 then HOME() end
end

function inLobby()

inLobbyOption = gg.multiChoice({
"1. 💥 No Recoil 💥 (Once)",
"2. ☠ Magic Bullet ☠ (Once)",
"3. 💀 Magic Bullet v1 💀 (Once)",
"4. ⚪ Perfect White Color ⚪ (Body + Vehicles, Once)",
"5. ⚫ Perfect Black Color ⚫ (Body + Vehicles, Once)",
"6. 🐺 Micro Aimbot 🐺 (Once)",
"7. 🦊 Medium Aimbot 🦊 (Once)",
"8. 🦁 Ultra Aimbot 🦁 (Once)",
"9. 👌 Small Crosshair 👌 (Once)",
"🔙 Back"} , nil, "Use In Lobby!")
if inLobbyOption == nil then
else
if inLobbyOption[1] == true then
   EE36()
   end
   if inLobbyOption[2] == true then
   EE41()
   end
   if inLobbyOption[3] == true then
   EE39()
   end
   if inLobbyOption[4] == true then
   EE49()
   end
   if inLobbyOption[5] == true then
   EE50()
   end
   if inLobbyOption[6] == true then
   EE48()
   end
   if inLobbyOption[7] == true then
   mediumAimbot()
   end
   if inLobbyOption[8] == true then
   ultraAimbot()
   end
   if inLobbyOption[9] == true then
    EE34()
   end
   if inLobbyOption[10] == true then
    HOME()
   end
 PD= -1
   end
...
function WH7() -- Wallhack Mediatek
...
gg.getResults(20)
gg.editAll("100", gg.TYPE_FLOAT)
gg.toast("Loading Mediatek Wallhack")
gg.clearResults()
gg.searchNumber("-1.0285578e-38;3.7615819e-37;2;-1;1;-127::300", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("2", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(12)
gg.editAll("120", gg.TYPE_FLOAT)
gg.toast("Mediatek Wallhack Activated!")
end
...
function WW9()
  ...
  gg.clearResults()
  gg.toast("Loading Purple Glowing HDR")
  gg.clearResults()
  gg.searchNumber("32,769;-2,134,900,722", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  gg.searchNumber("32769", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  gg.getResults(100)
  ...
  gg.clearResults()
  gg.toast("Purple Glowing HDR Activated!")
end
...
function WW13()
  ...
  gg.toast("New Color Pink Blue Activated!")
  gg.clearResults()
end
...
function inGame()
  inGameOption1 = gg.choice({
    "👁 Wallhacks and Colors 🎨",
    "📦	All Functions 📦	",
    "🔙 Back",}, nil, "Use In Game!")
  if inGameOption1 == 1 then inGameWallColors() end
  if inGameOption1 == 2 then inGameAll() end
  if inGameOption1 == 3 then HOME() end
end

function inGameWallColors()
  inGameOptionWallColors = gg.multiChoice({
    -- Wallhacks
    "1. 😍 Perfect Wallhack 😍",
    "2. 🤩 Wallhack - Snapdragon 430 🤩",
    "3. 😏 Wallhack - Snapdragon 625 😏",
    "4. 😮 Wallhack - Snapdragon 660 😮",
    "5. 😜 Wallhack - Snapdragon 8xx 😜",
    "6. 😱 Wallhack - All Snapdragon 😱",
    "7. 🤪 Wallhack - Mediatek 🤪",
    "8. 🐗 Wallhack - Kirin 🐗",
    "9. 😝 Wallhack - HDR 😝",
    -- Colors
    "10. 🤥 Random Color 🤥 (HDR)",
    "11. 🤫 Crystal Color 🤫 (Body + Vehicles)",
    "12. 🤭 Green Color 🤭 (Body + Vehicles)",
    "13. 🧐 Gradient Color 🧐 (Body + Vehicles)",
    "14. 🤓 Yellow Color 🤓 (Body + Vehicles)",
    "15. 🕺 Pink Color 🕺",
    "16. 💃 Pixel Color 💃 (Body + Vehicles)",
    "17. 👽 Purple Glowing 👽 (HDR)",
    "18. 👾 Blue 👾 (HDR)",
    "19. 😺 Red 😺 (HDR)",
    "20. 🙈 Green 🙈 (HDR)",
    "21. 👱 New Color 👱 (HDR)",
    ...
    } , nil , "Wallhacks and Colors \n⚠ WARNING: ALL FUNCTIONS FROM HERE MUST BE USED AFTER JUMP OFF AIRPLANE!")
  if inGameOptionWallColors == nil then
  else
    if inGameOptionWallColors[1] == true then WH1() end
    if inGameOptionWallColors[2] == true then WH2() end
    if inGameOptionWallColors[3] == true then WH3() end
    if inGameOptionWallColors[4] == true then WH4() end
    if inGameOptionWallColors[5] == true then WH5() end
    if inGameOptionWallColors[6] == true then WH6() end
    if inGameOptionWallColors[7] == true then WH7() end
    if inGameOptionWallColors[8] == true then EE52() end
    if inGameOptionWallColors[9] == true then WH8() end
    if inGameOptionWallColors[10] == true then WW3() end
    if inGameOptionWallColors[11] == true then WW4() end
    if inGameOptionWallColors[12] == true then WW5() end
    if inGameOptionWallColors[13] == true then WW6() end
    if inGameOptionWallColors[14] == true then YEL() end
    if inGameOptionWallColors[15] == true then BBR() end
    if inGameOptionWallColors[16] == true then PBB() end
    if inGameOptionWallColors[17] == true then WW9() end
    if inGameOptionWallColors[18] == true then WW10() end
    if inGameOptionWallColors[19] == true then WW11() end
    if inGameOptionWallColors[20] == true then WW12() end
    if inGameOptionWallColors[21] == true then WW13() end
    if inGameOptionWallColors[22] == true then inGame() end
  end
end


function inGameAll()
  inGameOptionAll = gg.multiChoice({
    -- Mostly used
    "1. 🌾 No Grass 🌾 (Landed)",
    "2. 📡 Running Antenna 📡 (While Running, After Pick Up Weapon)",
    "3. 🔭 High Level Items Antenna 🔭 (Once, Landed)",
    "4. 👀 Extended View 👀 (Island or Landed, TPP Only)",
    -- Aim & Fire
    "5. 🌪 Kar98k Instant Bullet 🌪 (After Pick Up Weapon)",
    "6. 🌀 SCAR Rapid Fire 🌀 (After Pick Up Weapon)",
    "7. 🔥 AKM Rapid Fire 🔥 (After Pick Up Weapon)",
    "8. ☄ M4 Rapid Fire ☄ (After Pick Up Weapon)",
    "9. 🔒 Aimlock 🔒 (After Pick Up Weapon)", -- ok
    -- Antenna
    "10. 🏹 Running Antenna 🏹 (After Pick Up Weapon, While Running)",
    "11. ⛺ Hand and Foot Antenna ⛺ (After Pick Up Weapon, Always)",
    "12. 🎒 Backpack Antenna 🎒 (Landed, While Running)",
    "13. 🕴 Standing Antenna 🕴 (After Pick Up Weapon, While Immobile)",
    "14. 🔝 Head Antenna 🔝 (After Pick Up Weapon, Dont Use in FPP, While Running)",
    -- Vehicles
    "15. 🚗 Buggy through the walls 🚗 (Landed)",
    "16. ⛽ Jeep Acceleration ⛽ (Landed)",
    "17. 🌊 Jeep Underwater 🌊 (Landed)",
    "18. 🚙 Mountain Climbing UAZ 🚙 (Use in UAZ)",
    -- Visual
    "19. 🌑 Black Sky 🌑 (Landed)",
    "20. 🌞 Clear Sky 🌞 (Landed)",
    "21. 🏔 White Land 🏔 (Landed)",
    "22. ⬛ Black Land ⬛ (Landed)",
    "23. 👁️‍🗨️ Item Wallhack 👁️‍🗨️ (Landed, Once)",
    "24. 🌲 No grass + No tree 🌲 (Landed)",
    -- Misc
    "25. 🏃 Speedhack 🏃 (Island or Landed, Dont Use With 'Fast Walk', Once)",
    "26. 🏃‍♀️ Micro Speedhack 🏃‍♀️ (Island or Landed)",
    "27. 🚶️ Fast Walk + Long Jump 🚶️ (Landed)",
    "28. 🤸 Multijump 🤸 (Landed, Use carefully)",
    "29. ⛑ Big Helmet ⛑ (Landed)",
    "30. 🤑 Less Recoil 🤑 (Landed)",
    "31. 👨‍🚀 Less Gravity 👨‍🚀 (Landed, Once)",
    "32. 🦒 High View 🦒 (After Pick Up Weapon, Crouch and Scope)",
    "33. 🦖 Big Character 🦖 (Landed)",
    "34. 🐜 Small Character 🐜 (Landed)",
    "🔙 Back",

    } , nil , "All In Game Functions")
  if inGameOptionAll == nil then
  else
    if inGameOptionAll[1] == true then noGrass() end
    if inGameOptionAll[2] == true then EE43() end
    if inGameOptionAll[3] == true then EE8() end
    if inGameOptionAll[4] == true then EE3() end
    if inGameOptionAll[5] == true then EE22() end
    if inGameOptionAll[6] == true then SCAR() end
    if inGameOptionAll[7] == true then AK() end
    if inGameOptionAll[8] == true then M4() end
    if inGameOptionAll[9] == true then EE31() end
    if inGameOptionAll[10] == true then runningAntenna() end
    if inGameOptionAll[11] == true then EE5() end
    if inGameOptionAll[12] == true then EE15() end
    if inGameOptionAll[13] == true then EE17() end
    if inGameOptionAll[14] == true then EE44() end
    if inGameOptionAll[15] == true then EE1() end
    if inGameOptionAll[16] == true then EE6() end
    if inGameOptionAll[17] == true then EE7() end
    if inGameOptionAll[18] == true then EE12() end
    if inGameOptionAll[19] == true then EE35() end
    if inGameOptionAll[20] == true then clearSky() end
    if inGameOptionAll[21] == true then EE37() end
    if inGameOptionAll[22] == true then blackLand() end
    if inGameOptionAll[23] == true then itemWallhack() end
    if inGameOptionAll[24] == true then EE13() end
    if inGameOptionAll[25] == true then EE9() end
    if inGameOptionAll[26] == true then microSpeedHack() end
    if inGameOptionAll[27] == true then hj() end
    if inGameOptionAll[28] == true then EE26() end
    if inGameOptionAll[29] == true then EE42() end
    if inGameOptionAll[30] == true then EE45() end
    if inGameOptionAll[31] == true then lessGravity() end
    if inGameOptionAll[32] == true then crouchAndScope() end
    if inGameOptionAll[33] == true then BIG() end
    if inGameOptionAll[34] == true then SMALL() end
    if inGameOptionAll[35] == true then inGame() end
  end
end

function runningAntenna()
  gg.clearResults()
...
function WW3()
  ...
  gg.toast("Random Color HDR Activated!")
  gg.clearResults()
end
...
function WW4()
  ...
  gg.toast('Crystal Color Activated!')
end
...
function WW6()
   ...
   gg.toast("Gradient Color Activated!")
end
...
gg.toast("Mountain Climbing UAZ Activated!") end
...
function EE36() -- No Recoil New WORKING 0.7.0
    gg.setRanges(gg.REGION_ANONYMOUS)
    gg.clearResults()
    gg.searchNumber("1868784978;1850305641;28518", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
    gg.searchNumber("1868784978", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
...
print('POWERED BY PUBGMHACKS.ONLINE')
print('Made by:')
print('@strangekillers')
print('@Memory')
print('@Thor')
print('@Sulimax')
print('@Xasikl')
...
print('DKcorp')
print('Matthew')
print('And All Other Staff members!')
os.exit()
end
